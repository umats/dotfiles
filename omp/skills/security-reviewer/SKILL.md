...
description: Use when reviewing code for security vulnerabilities, conducting security audits, analyzing infrastructure security, or scanning for secrets and dependencies. Performs SAST scans, penetration testing guidance, DevSecOps practices, cloud security reviews, and compliance checks. Produces vulnerability reports with severity ratings and actionable remediation guidance.
license: MIT
