---
name: flutter-expert
description: Use when building cross-platform mobile applications with Flutter 3+ and Dart. Implements widgets, sets up Riverpod or Bloc state management, configures GoRouter navigation, creates platform-specific code, and optimizes performance. Invoke for widget development, state management, navigation, animations, or Flutter app architecture.
license: MIT
