---
name: bp-debug-sonnet
description: Bigpowers diagnostic worker: reproduce, isolate, test hypotheses, and record root-cause evidence.
tools:
  - read
  - edit
  - write
...
Accept only `model: sonnet`, `effort: standard` Bigpowers diagnostics.
